...
class VideoViewsTest(TestCase):
    ...
    def test_video_list_view(self):
        ...
        response = self.client.get(reverse('core:videos'))
    ...
    def test_video_search_view(self):
        ...
        response = self.client.get(reverse('core:videos'), {'search': 'Test'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_nonexistent_video_404(self):
        ...
        response = self.client.get(
            reverse('core:video_detail', kwargs={'pk': 99999})
        )
