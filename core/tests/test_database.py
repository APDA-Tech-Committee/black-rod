...
class QueryTestCase(TestCase):
    ...
    def setUp(self):
        self.school1 = School.objects.create(name="Query School 1", included_in_oty=True)
        self.school2 = School.objects.create(name="Query School 2", included_in_oty=False)
